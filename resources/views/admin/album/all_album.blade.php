                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Album</li>
                                <li><a class="link-effect" href="/admin/album/create">Add </a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <?php  foreach ($albums as $key => $row) : ?>
                                    <tr>
                                        ...
                                        @else
                                        <td class="text-center"><img src="{{ asset('gallery_images/'.$row->banner) }}" class="tableimage"></td>
                                        @endif
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="/admin/album/{{ $row->id }}/edit" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                                                {!! Form::open(['action' => ['albumController@destroy', $row->id ], 'method' => 'POST']) !!}
                                                {{ method_field('DELETE') }}
