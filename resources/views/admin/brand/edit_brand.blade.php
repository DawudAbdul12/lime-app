        ...
        {{-- {!! Form::open(['action' => 'categoryController@store', 'method' => 'POST','files' => true,'class'=> 'form-horizontal push-10-t'] ) !!} --}}
            <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <input class="form-control" type="text" id="material-text2" name="title" required  value="{{$brand->title}}">
             ...
             <div class="form-group">
                    <div class="col-sm-12">
                            <label for="material-text2"> Description. If any</label>
                        <div class="form-material floating">
             ...
             <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <div class="form-material floating">
                                ...
                                <br>
                        @if($brand->image != "")
                        <img src="{{asset('brand_img/'.$brand->image)}}" class="thumbimage" >
                        @endif
                        </div>
                    </div>
             </div>
