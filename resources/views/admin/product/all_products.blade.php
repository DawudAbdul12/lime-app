                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Projects</li>
                                <li><a class="link-effect" href="/admin/project/create">Add project</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <?php  foreach ($products as $key => $row) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="/admin/project/{{ $row->id }}/edit" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
