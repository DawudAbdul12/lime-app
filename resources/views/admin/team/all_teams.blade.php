                    ...
                    <div class="row items-push">
                        ...
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Teams</li>
                                <li><a class="link-effect" href="/admin/team/create">Add team</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <?php  foreach ($teams as $key => $row) : ?>
                                    <tr>
                                        ...
                                        @else
                                        <td class="text-center"><img src="{{ asset('team_profile/'.$row->profile_pic) }}" class="tableimage"></td>
                                        @endif
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="/admin/team/{{ $row->id }}/edit" class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>
                                                {!! Form::open(['action' => ['teamController@destroy', $row->id ], 'method' => 'POST']) !!}
                                                {{ method_field('DELETE') }}
