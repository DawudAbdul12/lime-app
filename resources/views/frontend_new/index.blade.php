...
<head>
  ...
  <section class="homeSlider">
    ...
    <ol class="carousel-indicators">
      ...
      {{-- <li data-target="#imgCarousel" data-slide-to="1"><img src="img/bg2.png" alt=""></li>
      <li data-target="#imgCarousel" data-slide-to="2"><img src="img/bg3.png" alt=""></li>
      <li data-target="#imgCarousel" data-slide-to="3"><img src="img/bg4.png" alt=""></li> --}}
    </ol>
    <!--/.Indicators-->
    <!--Slides-->
...
{{-- 
      <div class="carousel-item">
        ...
        <img class="d-block w-100" src="img/bg2.png"
            alt="Second slide">
      </div>
      <div class="carousel-item">
        <div class="sliderOverlay"></div>
        <img class="d-block w-100" src="img/bg3.png"
            alt="Third slide">
      </div>
      <div class="carousel-item">
        <div class="sliderOverlay"></div>
        <img class="d-block w-100" src="img/bg4.png"
            alt="Fourth slide">
      </div>  --}}
    </div>
    <!--/.Slides-->
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-md-5">
          ...
          <h4 class="wc mb-4">Our <strong>Objectives </strong> </h4>
       ...
       <div class="col-12 col-md-8">
         <div class="row ">
          @foreach ($products as $product)
            ...
            <div class="col-12 col-md-6 centeritem mb-5">
         ...
         @endforeach
          ...
          {{-- <div class="col-12 col-md-6 centeritem mb-5">
            <div class="row">
              <div class="col-5">
                <img src="img/p1.png" class="img-fluid rounded-circle2" alt="">
              </div>
              <div class="col-7">
                <div class="wc">
                  <h3><strong>UREA</strong> </h3>
                  <p class="mb-0 product-mini ">CAS No.: 57-13-6</p>
        ...
        <div class="col-12 col-md-4  mb-4">
          ...
          <div class="entervas-konko mb-3">
            <a href="/news/{{ $row->slug }}">
              ...
              <p class="flagt4 mb-0">{{ $row->title}}</p>
            </div>
          </a>
        </div>
